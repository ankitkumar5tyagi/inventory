<x-Layout>
    ...
    <form action="{{ route('supplier.update', $supplier) }}" method="POST">
        ...
        <div class="inputdiv">
            ...
            <input type="checkbox" id="statusbox" name="status" value="{{ ($supplier->status)? $supplier->status : "1" }}" {{ ($supplier->status == 1)? "checked" : ""}} @error('status') style="border-color: red;" @enderror>
